...
-77 103 -72 68 -126 89 -235 93 -77 3 -98 0 -147 -20z"/>
                    ...
                    <div className="form-container">
                        <h3 className=" daily">Your session has ended.</h3>
                        <h3 className=" daily1">No time to Waste sessions are open for a<br/>  limited time and yours has ended.</h3>
