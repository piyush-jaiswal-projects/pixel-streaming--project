...
function dailysessionexceed({ language }) {
...
-77 103 -72 68 -126 89 -235 93 -77 3 -98 0 -147 -20z"/>
                    ...
                    <div className="form-container">
                        <h3 className=" daily">Maximum Number of<br /> sessions for today exceeded.</h3>
                        <h3 className=" daily1">Streaming sessions are limited for each day<br/> in order to provide the best possible<br /> experience for those streaming the No time <br /> to Waste.</h3>
                        <span className="daily2">Please try again tomorrow. </span>
...
export default dailysessionexceed;